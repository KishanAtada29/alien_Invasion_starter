...
class HUD:
    ...
    def __init__(self, game):
        """Initialize HUD settings, font, score images, level, and life images."""
        self.game = game
    ...
    def _update_score(self):
        """Create the current score image."""
    ...
    def update_level(self):
        """Create the current level image."""
    ...
    def _draw_lives(self):
        """Draw ship icons for the player's remaining lives."""
